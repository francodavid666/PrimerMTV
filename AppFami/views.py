...
from .models import familiar_1, familiar_2, familiar_3
...
def fami (request):
    ...
    diccionario = {"nombre": gisel.nombre,"apellido":gisel.apellido,"edad":gisel.edad,
    ...
    mihtml = open("C:/Users/david/OneDrive/Escritorio/PrimerMTV/ProyectoFami/Plantillas/templade1.html")
